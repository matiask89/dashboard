...
import sty from "./PlasmicDateTimeRangePicker.module.css"; // plasmic-import: BeO20828hgvb/css
            ...
            <React.Fragment>
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__eUslY
                  ),
                  picker: "date",
                  popupScopeClassName:
                    sty["dateTimePicker__eUslY__datePickerPopup"],
                  showTime: false
                };
              ...
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__gTrsu
                  ),
                  popupScopeClassName:
                    sty["dateTimePicker__gTrsu__datePickerPopup"],
                  showTime: false
                };
                return <AntdDatePicker {...child$Props} />;
              })()}
